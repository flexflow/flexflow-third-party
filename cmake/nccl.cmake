...
#message(STATUS "NCCL NVCC gencode: ${NCCL_BUILD_NVCC_GENCODE}")
...
ExternalProject_Add(${NCCL_NAME}
 ...
 # Let NCCL autodetect the version of CUDA, and compile with all compatible gencodes.
 BUILD_COMMAND make src.build "CUDA_HOME=${CUDA_TOOLKIT_ROOT_DIR}" "BUILDDIR=${CMAKE_BINARY_DIR}/deps/${NCCL_NAME}"
 BUILD_IN_SOURCE 1
)
